...
class Point(object):
    ...
    def move_by(self, x, y):
        ...
        newd = (x ** 2 + y ** 2) ** 0.5
        self.getNums = self.getNums + 1
        self.distance = self.distance + newd
    ...
    def get_distance_from_start(self):
        point_x = self.originalX
        point_y = self.originalY
        return self.get_distance_from(Point(point_x,point_y))
